...
LOGFORMAT=${36}
LOGLEVEL=${37}
MIRRORCONSOLEMESSAGESTOLOG=${38}
MISSINGPROPERTYMODE=${39}
MONITORPERFORMANCE=${40}
NATIVEEXECUTOR=${41}
ONMISSINGINCLUDECHANGELOG=${42}
OUTPUTFILE=${43}
...
SHOWBANNER=${57}
SQLLOGLEVEL=${58}
SQLSHOWSQLWARNINGS=${59}
STRICT=${60}
SUPPORTPROPERTYESCAPING=${61}
USEPROCEDURESCHEMA=${62}
VALIDATEXMLCHANGELOGFILES=${63}
